    ...
    <SiteLayout>
      <section className="border-b border-border bg-gradient-to-br from-primary/5 to-accent/5">
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          <h1 className="text-3xl font-extrabold text-secondary md:text-4xl">Contact</h1>
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Besoin d'aide, d'une information ou d'un partenariat ? Contactez l'équipe GalléExpress directement par e-mail, téléphone ou via nos réseaux sociaux.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="rounded-3xl border border-border bg-card p-8 shadow-card">
            <h2 className="text-xl font-semibold text-secondary">Nous écrire</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Pour toute question générale, support client ou partenariat, utilisez ces coordonnées.
            </p>
          ...
          <div className="rounded-3xl border border-border bg-card p-8 shadow-card">
            <h2 className="text-xl font-semibold text-secondary">Réseaux sociaux</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Suivez-nous pour rester informé des dernières offres, nouveautés et annonces GalléExpress.
            </p>
          ...
          <div className="rounded-3xl border border-border bg-secondary p-8 shadow-card">
            <h2 className="text-xl font-semibold text-secondary">Pour les prestataires</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              Si vous voulez proposer un service ou rejoindre notre plateforme en tant que prestataire, utilisez le formulaire dédié.
            </p>
            <Link
              to="/proposer"
